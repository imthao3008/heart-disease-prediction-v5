    ...
    with shap_tab4:
        ...
        with col_sp2:
            ...
            for n1, n2, note in pairs_info:
                idx1 = list(MODEL_COLORS.keys()).index(
                    [k for k in MODEL_COLORS if k.startswith(n1) or n1 in k][0])
                idx2 = list(MODEL_COLORS.keys()).index(
                    [k for k in MODEL_COLORS if k.startswith(n2) or n2 in k][0])
